                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="padding: 0;">
                                            ...
                                            <asp:TextBox ID="txtDESCRIPTION_CN" runat="server" TextMode="MultiLine" Rows="3" class="form-control" Style="border: none;" OnTextChanged="txtDescription_TextChanged" AutoPostBack="true"></asp:TextBox>
