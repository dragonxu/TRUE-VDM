<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_Service_SaveOrder.ascx.vb" Inherits="VDM.UC_Service_SaveOrder" %>
<table>
      <tr>
                        <td colspan ="3"><h3 style="text-align :center ;">  Service_SaveOrder</h3></td>
