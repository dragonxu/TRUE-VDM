<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_Service_GenerateOrderID.ascx.vb" Inherits="VDM.UC_Service_GenerateOrderID" %>
<table>
      <tr>
                        <td colspan ="3"><h3 style="text-align :center ;"> Service_GenerateOrderID</h3></td>
    ...
    <tr style ="vertical-align :top;">
        <td style="line-height: 2;"> 
                <table>                   
                    ...
                    <tr>
                        <td>channel</td>
                        <td><asp:TextBox ID="channel" runat="server" ></asp:TextBox></td>
                    </tr> 
                    <tr>
                        <td>dealer</td>
