...
(function ($) {
	...
	$.fn.onScreenKeyboard = function (options) {
        ...
        // Custom Style
		$keyboard.css('width', 'auto');
		$keyboard.css('top', settings.topPosition);
		$keyboard.css('left', settings.leftPosition);
		$keyboard.css('bottom', settings.bottomPosition);
		$keyboard.css('right', settings.rightPosition);
		$keyboard.css('margin', settings.margin);
