<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="Report_Product_Stock.aspx.vb" Inherits="VDM.Report_Product_Stock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="title">Reports &gt; สินค้าคงเครื่อง</div>
    </div>
                                ...
                                <asp:Repeater ID="rptData" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td data-title="MOVEMENT" style ="text-align :center ;">
