...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="udpEdit" runat="server">
        <Triggers>
            <asp:PostBackTrigger ControlID="btnUpdateLogo_TH" />
        </Triggers>
        <Triggers>
            <asp:PostBackTrigger ControlID="btnUpdateLogo_EN" />
        </Triggers>
        <Triggers>
            <asp:PostBackTrigger ControlID="btnUpdateLogo_CH" />
        </Triggers>
        <Triggers>
            <asp:PostBackTrigger ControlID="btnUpdateLogo_JP" />
        </Triggers>
        <Triggers>
            <asp:PostBackTrigger ControlID="btnUpdateLogo_KR" />
        </Triggers>
        <Triggers>
            <asp:PostBackTrigger ControlID="btnUpdateLogo_RS" />
        </Triggers>
        <ContentTemplate>
                                ...
                                <div class="card-block p-a-0">
                                    <div class="box-tab m-b-0">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <%-- <li id="Tab_CHINESE" runat="server" class=""><a href="#CHINESE" data-toggle="tab">CHINESE</a>
                                            </li>
                                            <li id="Tab_JAPANESE" runat="server" class=""><a href="#JAPANESE" data-toggle="tab">JAPANESE</a>
                                            </li>
                                            <li id="Tab_KOREAN" runat="server" class=""><a href="#KOREAN" data-toggle="tab">KOREAN</a>
                                            </li>
                                            <li id="Tab_RUSSIAN" runat="server" class=""><a href="#RUSSIAN" data-toggle="tab">RUSSIAN</a>
                                            </li>--%>
                                        </ul>
