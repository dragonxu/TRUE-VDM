                        ...
                        <div class="detail-slider">
                            ...
                            <div class="frame">
                                ...
                                <div class="detail-sim" style ="margin-bottom:10px; width:80%; text-align:center;">
                                    ...
                                    <asp:Image ID="imgPrice" runat="server" Height="450px" style="width:unset;"></asp:Image>
                                </div>
                                <div class="true-l">
                                    <div class="term" style="margin: unset;">
                                ...
                                <div class="list" style="margin-bottom: unset;">
                                    <li class="no-border">
                                        <h3 class="true-l" style="width: unset; margin-right: 20px;">
                                            <asp:Label ID="lblPrice_str" runat="server" class="true-l" Text="เริ่มต้นเพียง"></asp:Label></h3>
