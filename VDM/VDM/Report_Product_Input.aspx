<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="Report_Product_Input.aspx.vb" Inherits="VDM.Report_Product_Input" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title" style="">
        <div class="title">Reports &gt; การนำสินค้าเข้าเครื่อง</div>
    </div>
