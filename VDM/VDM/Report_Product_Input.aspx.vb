...
Public Class Report_Product_Input
    ...
    Private Sub BindData()
        lblHeader.Text = "รายงานการนำสินค้าเข้าเครื่อง "
        Dim Sql As String = ""

        Sql &= " Select * " & vbLf
        Sql &= " FROM( " & vbLf
        Sql &= "         SELECT 'PRODUCT' ITEM_TYPE, * FROM VW_RPT_PRODUCT_INPUT " & vbLf
        Sql &= " UNION ALL  " & vbLf
        Sql &= "         SELECT 'SIM' ITEM_TYPE, * FROM VW_RPT_SIM_INPUT " & vbLf
        ...
        Session("Report_Product_Input") = DT
        Pager.SesssionSourceName = "Report_Product_Input"
        Pager.RenderLayout()
